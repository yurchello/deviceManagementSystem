...
public class DevicesView extends VerticalLayout implements BaseView{
    ...
    private VerticalLayout userLayout(UserDto userDto){
        ...
        devicesButton.addClickListener(action -> getUI().getNavigator().navigateTo(UsersView.VIEW_NAME));
        ...
        backButton.addClickListener(action -> getUI().getNavigator().navigateTo(UsersView.VIEW_NAME));
